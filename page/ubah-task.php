<?php
	...
	$users = $_SESSION['nama'];
    $id = $_GET['id'];
    $sql2 = "SELECT * FROM tb_task WHERE id='$id'";
    $query = mysqli_query($koneksi, $sql2);
    $row = mysqli_fetch_array($query);
    $tgl1 = $row['start_date'];
    $tgl2 = $row['end_date'];
    $start = date('d-m-Y', strtotime($tgl1));
    $end = date('d-m-Y', strtotime($tgl2));
?>
<!DOCTYPE html>
<html>
<head>
		...
		<div class='row'>
			<div class='col-md-8'>
				<div class='box box-warning'>
					...
					<div class='box-body'>
						<form role='form' method='post' action='aksi-ubah-task.php?id=<?php echo $id; ?>' class='form-horizontal' enctype='multipart/form-data' onsubmit='return validasi_input(this)'>
						
							<div class='form-group'>
								<label class='col-sm-2 control-label'>PROJECT NAME</label>
								<div class='col-sm-10'>
									<input type='text' value='<?php echo $row['project_name']; ?>' name='project' class='form-control' placeholder='PROJECT NAME' autocomplete="off" required >
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class='col-sm-10'>
									<input type='text' value='<?php echo $row['sub_project']; ?>' name='sub' class='form-control' placeholder='SUB PROJECT' autocomplete="off" required >
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class='col-sm-10'>
									<input type='text' value='<?php echo $row['detail_activity']; ?>' name='activity' class='form-control' placeholder='DETAIL ACTIVITY' autocomplete="off" required>
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class='col-sm-10'>
									...
									<div class="input-group-addon">
										...
										<input type="text" value='<?php echo $start; ?>' placeholder="" class="form-control" id="start" name="start" required>
									</div> 
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class='col-sm-10'>
									...
									<div class="input-group-addon">
										...
										<input type="text" value='<?php echo $end; ?>' placeholder="" class="form-control" id="end" name="end" required>
									</div>  
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class='col-sm-10'>
									...
									<div class="input-group-addon">
										...
										<input type='text' value='<?php echo $row['duration']; ?>' name='duration' id='hasil' class='form-control' placeholder='DURATION' autocomplete="off" readonly>
									</div>
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class='col-sm-10'>
									<input type='text' value='<?php echo $row['remark']; ?>' name='remark' class='form-control' placeholder='REMARK' autocomplete="off">
								</div>
							</div>
						<!-- /.input group -->
					</div>
